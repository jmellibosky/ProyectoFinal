<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRestauracionFinalizada.aspx.cs" Inherits="REApp.Forms.UserRestauracionFinalizada" %>
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col col-xl-6">
            <div class="card" style="border-radius: 1rem;">
                ...
                <form id="FormRestauracionCorrecta" runat="server">
                    ...
                    <div class="d-flex align-items-center mb-3 pb-1">
                        <span class="h1 fw-bold mb-1 font-weight-bolder text-center" >¡Cambio de Contraseña exitoso!</span>   
                    </div>
