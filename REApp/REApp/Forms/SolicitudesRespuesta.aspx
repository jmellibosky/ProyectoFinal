...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        <h1 class="row justify-content-center mb-0 pb-0 pt-5">
            <label style="font-style: italic; font-family: 'REM', sans-serif; letter-spacing: 3px; text-shadow: inherit; font-weight: 600" class="fw-normal mb-3 pb-2">Gestión de Solicitudes en Respuesta</label>
        </h1>
    ...
    <div style="text-align: end;">
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <asp:Button ID="btnRespuestaPDF" Text="Generar Respuesta" Visible="false" CssClass="btn btn-info btn-dark no-gif" runat="server" OnClick="btnRespuestaPDF_Click" />
