<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserValidation.aspx.cs" Inherits="REApp.Forms.UserValidation" %>
                        ...
                        <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            <form id="FormCorrectRegister" runat="server">
                                ...
                                <div class="d-flex align-items-center mb-3 pb-1">
                                    <asp:Panel ID="pnlTituloExito" runat="server">
                                        <span class="h1 fw-bold mb-1 font-weight-bolder text-center">¡Registro realizado exitosamente!</span>
                                    </asp:Panel>
                                    <asp:Panel ID="pnlTituloError" runat="server">
                                        <span class="h1 fw-bold mb-1 font-weight-bolder text-center">Error</span>
                                    </asp:Panel>
                                </div>

                                <div class="d-flex mb-3 pb-1">
                                    <asp:Panel ID="pnlMensajeExito" runat="server">
                                    ...
                                    <asp:Panel ID="pnlMensajeError" runat="server">
                                        <span class="h1 fw-bold mb-1 font-weight-bolder text-center">Algo salió mal...</span>
                                    </asp:Panel>
                                </div>
