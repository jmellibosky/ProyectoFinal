...
<asp:Content ID="cBody" ContentPlaceHolderID="cphBody" runat="server">
        ...
        <h1 class="row justify-content-center mb-0 pb-0 pt-5">
            <label style="font-style: italic; font-family:'REM', sans-serif; letter-spacing: 3px" class="fw-normal mb-3 pb-2">Gestión de Vants</label>
        </h1>
                                                            ...
                                                            <asp:TemplateField  ItemStyle-Width="20%" ItemStyle-Wrap="false" HeaderText="ACCIONES">  
                                                                ...
                                                                <asp:LinkButton ID="btnDetalleVant" runat="server" OnClick="btnDetalleVant_Click"
                                                                    CommandArgument='<%# Eval("IdVant") %>'>
                                                                        <i class="fa fa-eye" aria-hidden="true" CssClass="no-gif" style='font-size:15px; color:#525252' ></i> 
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton ID="btnModificarVant"  runat="server" CssClass="no-gif" OnClick="btnModificarVant_Click" ToolTip='<%# (Eval("VinculadoSolicitud").ToString() == "1") ? "Este VANT se encuentra vinculado a una solicitud vigente." : "" %>' Enabled='<%# (Eval("VinculadoSolicitud").ToString() == "1") ? false : true %>'
                                                                    CommandArgument='<%# Eval("IdVant") %>' >
                                                                        <i class="fa fa-pencil" aria-hidden="true" style='font-size: 15px; color: #525252'></i>
                                                                    </asp:LinkButton> 
                                                                    <asp:LinkButton ID="btnEliminarVant" runat="server" CssClass="no-gif" OnClick="btnEliminarVant_Click" ToolTip='<%# (Eval("VinculadoSolicitud").ToString() == "1") ? "Este VANT se encuentra vinculado a una solicitud vigente." : "" %>' Enabled='<%# (Eval("VinculadoSolicitud").ToString() == "1") ? false : true %>'
                                                                    CommandArgument='<%# Eval("IdVant") %>'>
