                        ...
                        <asp:Panel runat="server" ID="pnlBtnSubirArchivoCertCompetencia">
                            <div class="row">
                                <asp:LinkButton ID="lnkUpload3" runat="server" OnClick="Upload_Click"
                                    CommandArgument="3">
                                    <asp:Button ID="Button2" runat="server" Text="Subir Archivo3" OnClick="Upload_Click" CssClass="btn btn-dark" />
                                </asp:LinkButton>
                            </div>
                        </asp:Panel>
                        <br />
                        ...
                        <asp:Panel runat="server" ID="pnlBtnSubirArchivoCevant">
                            <div class="row">
                                <asp:LinkButton ID="lnkUpload4" runat="server" OnClick="Upload_Click"
                                    CommandArgument="4">
                                    <asp:Button ID="Button3" runat="server" Text="Subir Archivo3" OnClick="Upload_Click" CssClass="btn btn-dark" />
                                </asp:LinkButton>
                            </div>
                        </asp:Panel>
                        <br />
